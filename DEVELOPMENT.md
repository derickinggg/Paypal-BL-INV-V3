...
```bash
git remote add encore encore://paypal-balance-app-qca2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/paypal-balance-app-qca2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/paypal-balance-app-qca2/settings/integrations/github)
