...
export class Client {
    ...
    public readonly paypal: paypal.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.paypal = new paypal.ServiceClient(base)
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getBalance as api_paypal_balance_getBalance } from "~backend/paypal/balance";
import {
    deleteCredentials as api_paypal_credentials_deleteCredentials,
    getCredentials as api_paypal_credentials_getCredentials,
    saveCredentials as api_paypal_credentials_saveCredentials
} from "~backend/paypal/credentials";
import { createPayment as api_paypal_payment_createPayment } from "~backend/paypal/payment";
...
export namespace paypal {
    ...
    export class ServiceClient {
         ...
         */
        public async createPayment(params: RequestType<typeof api_paypal_payment_createPayment>): Promise<ResponseType<typeof api_paypal_payment_createPayment>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/paypal/payment`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_paypal_payment_createPayment>
        }

        /**
         * Deletes PayPal credentials by ID.
         */
        public async deleteCredentials(params: { id: string }): Promise<void> {
            await this.baseClient.callTypedAPI(`/paypal/credentials/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
        }

        /**
         * Retrieves PayPal account balance information.
         */
        public async getBalance(params: RequestType<typeof api_paypal_balance_getBalance>): Promise<ResponseType<typeof api_paypal_balance_getBalance>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/paypal/balance`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_paypal_balance_getBalance>
        }

        /**
         * Retrieves all PayPal credentials for the user (without exposing secrets).
         */
        public async getCredentials(params: RequestType<typeof api_paypal_credentials_getCredentials>): Promise<ResponseType<typeof api_paypal_credentials_getCredentials>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/paypal/credentials`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_paypal_credentials_getCredentials>
        }

        /**
         * Saves encrypted PayPal API credentials for the user.
         */
        public async saveCredentials(params: RequestType<typeof api_paypal_credentials_saveCredentials>): Promise<void> {
            await this.baseClient.callTypedAPI(`/paypal/credentials`, {method: "POST", body: JSON.stringify(params)})
        }
    }
}
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getHistory as api_transaction_history_getHistory } from "~backend/transaction/history";
...
export namespace transaction {
    ...
    export class ServiceClient {
         ...
         */
        public async getHistory(params: RequestType<typeof api_transaction_history_getHistory>): Promise<ResponseType<typeof api_transaction_history_getHistory>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                environment: params.environment,
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_transaction_history_getHistory>
        }
    }
}
